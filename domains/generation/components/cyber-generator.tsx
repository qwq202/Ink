...
import { GenerationForm } from "@/domains/generation/components/generation-form"
import { SettingsDialog } from "@/domains/settings/components/settings-dialog"
import { useImageUpload } from "@/domains/generation/hooks/use-image-upload"
import { useGeneration } from "@/domains/generation/hooks/use-generation"
import { cn } from "@/lib/utils"
import { parseImageSize } from "@/domains/generation/lib/image-utils"
import {
  ArrowLeft,
  Settings,
  Upload,
...
import { TaskStatusPanel } from "@/domains/generation/components/task-status-panel"
import { OnboardingWizard } from "@/domains/settings/components/onboarding-wizard"
import { useOnboarding } from "@/domains/settings/hooks/use-onboarding"
import { VariantGeneratorDialog } from "@/domains/generation/components/variant-generator-dialog"
import { ImageComparisonView } from "@/domains/generation/components/image-comparison-view"
import { ImageEditorDialog } from "@/domains/generation/components/image-editor-dialog"
      ...
      {filteredHistory.length === 0 && (
        <div className="flex flex-col items-center justify-center min-h-[300px] gap-4 text-center">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">生成图片后会自动保存到这里</p>
          </div>
        </div>
      )}
    </div>
